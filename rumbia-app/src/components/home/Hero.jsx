        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="relative">
              <h1 className="text-4xl lg:text-6xl xl:text-7xl font-black leading-[1.1] tracking-tight">
                ...
                <span className="relative inline-block group">
                  ...
                  <div className="absolute -bottom-3 left-0 right-0 h-2 bg-gradient-to-r from-transparent via-[#378BA4] to-transparent rounded-full blur-sm"></div>
                  <div className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#378BA4] to-transparent rounded-full"></div>
                </span>
              </h1>
            </div>

            {/* Descripción con glassmorphism */}
            <div className="relative p-5 lg:p-6 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl">
            ...
            <div className="flex flex-wrap gap-4">
              <button
                className="group relative px-8 lg:px-10 py-4 lg:py-5 bg-gradient-to-r from-[#378BA4] to-[#036280] text-white font-bold text-base lg:text-lg rounded-2xl shadow-2xl shadow-[#378BA4]/50 hover:shadow-[#378BA4]/80 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 overflow-hidden"
                style={{
              ...
              >
                <span className="relative z-10 flex items-center gap-3">
                  ...
                  Reservar sesión
                  <span className="group-hover:translate-x-2 transition-transform text-xl lg:text-2xl">→</span>
                </span>
              ...
              <button
                className="group relative px-8 lg:px-10 py-4 lg:py-5 bg-white/10 backdrop-blur-xl border-2 border-white/20 hover:border-[#378BA4] text-white font-bold text-base lg:text-lg rounded-2xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 overflow-hidden"
              >
                <span className="relative z-10 flex items-center gap-3">
                  <span className="text-xl lg:text-2xl group-hover:rotate-12 transition-transform">💬</span>
                  Contáctanos
                </span>
            ...
            <div className="grid grid-cols-4 gap-3">
              {[
                { value: "500+", label: "Sesiones", delay: 0 },
                { value: "4.9★", label: "Rating", delay: 100 },
                { value: "24/7", label: "Online", delay: 200 },
                { value: "🇵🇪", label: "Perú", delay: 300 }
              ].map((stat, i) => (
                <div
                  key={i}
                  className="group relative p-3 lg:p-4 rounded-xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 hover:border-[#378BA4]/50 transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 cursor-default"
                  style={{
                ...
                >
                  <div className="text-center">
                    <div className="text-2xl lg:text-3xl xl:text-4xl font-black text-white mb-1 group-hover:scale-110 transition-transform">{stat.value}</div>
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <div
                  key={i}
                  className={`group px-5 lg:px-6 py-2.5 lg:py-3 bg-gradient-to-r ${tag.color} backdrop-blur-xl rounded-full border border-white/20 hover:border-[#378BA4] transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 cursor-default shadow-lg`}
                >
                  <span className="flex items-center gap-2 text-white font-bold text-sm">
                    <span className="text-base lg:text-lg group-hover:scale-125 group-hover:rotate-12 transition-transform">{tag.icon}</span>
                    {tag.text}
                  </span>
                </div>
              ))}
                ...
                <div className="p-5 lg:p-6 space-y-4">
                  <div className="aspect-video rounded-2xl overflow-hidden relative group shadow-2xl">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-16 lg:w-20 h-16 lg:h-20 rounded-full bg-white/20 backdrop-blur-xl border-4 border-white/40 flex items-center justify-center group-hover:scale-110 group-hover:bg-[#378BA4]/40 transition-all duration-300 shadow-2xl cursor-pointer">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <div className="bg-white/10 backdrop-blur-xl rounded-xl p-3 lg:p-4 border border-white/20">
                        <div className="flex items-center gap-3">
                          <div className="w-10 lg:w-12 h-10 lg:h-12 rounded-full bg-gradient-to-br from-[#378BA4] to-[#036280] flex items-center justify-center text-white font-bold text-base lg:text-lg shadow-xl">
                            A
                          </div>
                          <div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {[
                      ...
                      <div
                        key={i}
                        className={`group relative p-3 lg:p-4 rounded-xl bg-gradient-to-r ${item.gradient} backdrop-blur-xl border border-white/20 hover:border-[#378BA4] transition-all duration-300 transform hover:translate-x-2 hover:scale-105 cursor-default overflow-hidden`}
                      >
                        <div className="relative z-10 flex items-center gap-3">
                          <span className="text-2xl lg:text-3xl group-hover:scale-125 group-hover:rotate-12 transition-transform">{item.icon}</span>
