...
const ProfileHeader = ({ userData, onEditPicture }) => {
  ...
  return (
    // Eliminamos el bg-blur y el borde estilo card para un look más integrado
    <div className="py-4">
      <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
        
        {/* Contenedor de la Imagen */}
        <div className="relative group">
          <div className="w-24 h-24 md:w-32 md:h-32 rounded-full overflow-hidden border-[3px] border-[#012E4A] bg-[#036280]/20 shadow-sm ring-2 ring-[#378BA4]/30">
            {mentorImageUrl ? (
              <img
                src={mentorImageUrl}
                ...
                onError={(e) => {
                  ...
                  e.target.parentElement.innerHTML = `
                    <div class="w-full h-full flex items-center justify-center">
                      <svg class="w-14 h-14 text-[#378BA4]/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {hasMentor && (
            <button
              ...
              className="absolute bottom-0 right-0 p-1.5 bg-[#378BA4] rounded-full border-2 border-[#012E4A] text-white shadow-sm hover:bg-[#036280] hover:scale-105 transition-all md:opacity-0 md:group-hover:opacity-100"
