...
const ProfileHeader = ({ userData, onEditPicture }) => {
  ...
  // URL de imagen (Solo lógica de Mentor)
  ...
  // -----------------------------------------------------------------------
  // 1. VISTA MENTOR (TU CÓDIGO ORIGINAL INTACTO)
  // -----------------------------------------------------------------------
  if (hasMentor) {
    const AvatarContent = (
  ...
  // -----------------------------------------------------------------------
  // 2. VISTA LEARNER (NUEVA: Sin foto, simple, profesional)
  // -----------------------------------------------------------------------
  ...
  return (
    <div className="bg-[#012E4A]/80 backdrop-blur-xl rounded-xl border border-[#378BA4]/30 p-6 shadow-xl">
      <div className="flex flex-col items-center text-center">
        ...
        {/* Monograma de Iniciales (Estilo Profesional Simple) */}
        <div className="mb-4">
          <div className="w-20 h-20 rounded-full bg-[#378BA4]/20 border border-[#378BA4]/50 flex items-center justify-center shadow-inner">
            <span className="text-2xl font-bold text-[#81E6D9] tracking-wider">
              {initials}
            </span>
          </div>
        </div>
        ...
        {/* Badge Learner */}
        <div className="w-full flex justify-center border-t border-[#378BA4]/20 pt-4">
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-md text-xs font-medium bg-blue-500/10 text-blue-200 border border-blue-500/20 select-none">
